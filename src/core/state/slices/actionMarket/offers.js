...
export function normalizeActionMarketOffer(offer, {
  ...
  const templateCategory = (() => {
    if (typeof offer.templateCategory === 'string' && offer.templateCategory.trim().length) {
      return offer.templateCategory.trim();
    }
