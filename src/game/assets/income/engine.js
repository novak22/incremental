...
export default function resolveIncomeFromBase({
  definition,
  assetState,
  instance,
  baseAmount,
  triggerEvents = INCOME_ENGINE_DEFAULT_OPTIONS.triggerEvents,
  updateInstance = INCOME_ENGINE_DEFAULT_OPTIONS.updateInstance
}) {
