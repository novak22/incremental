...
- **BankApp** – The browser shell’s SSO grid now includes a dedicated BankApp tile that opens a finance dashboard with live cash balances, today’s ledger, upkeep obligations, pending payouts, and opportunity scouting.
