...
- **BankApp** – The browser shell’s SSO grid now includes a dedicated BankApp tile that opens a finance dashboard with current balance, Net / Day, Daily +, Daily -, the classic ledger, a rolling seven-day cashflow timeline, and a live activity log feed.
