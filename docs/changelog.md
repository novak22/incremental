...
## Unreleased
- UI: DownWork workspace now renders as a dense marketplace table with ROI sorting, inline accept buttons, and a slide-up drawer for deep gig context so players can compare 15 contracts without scrolling a wall of cards.
